...
.directive('pagination', ['$parse', 'paginationConfig', function($parse, paginationConfig) {
  return {
    ...
    templateUrl: 'template/pagination/pageSelector.html',
    replace: true,
    link: function(scope, element, attrs, ctrls) {
...
angular.module("template/pagination/pageSelector.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/pagination/pageSelector.html",
    "<ul class=\"pagination\">\n" +
