Contributing to Cikl
============================

You're encouraged to submit [pull requests](https://github.com/cikl/cikl/pulls), [propose features and discuss issues](https://github.com/cikl/cikl/issues).

#### Fork the Project

Fork the [project on Github](https://github.com/cikl/cikl) and check out your copy.

```
git clone https://github.com/contributor/cikl.git
cd cikl
git remote add upstream https://github.com/cikl/cikl.git
```
...
Go to https://github.com/contributor/cikl and select your feature branch. Click the 'Pull Request' button and fill out the form. Pull requests are usually reviewed within a few days.
...
```
* [#123](https://github.com/cikl/cikl/pull/123): Reticulated splines - [@contributor](https://github.com/contributor).
```
